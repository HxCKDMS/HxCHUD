...
public class RenderHPEvent {
    ...
    public void renderHealthBar(RenderGameOverlayEvent.Pre event) {
        ...
        if (event.getType() == RenderGameOverlayEvent.ElementType.HEALTH) {
            ...
            if (mc.thePlayer.isRidingHorse() && mc.thePlayer.getRidingEntity() instanceof EntityLiving) {
                EntityLiving mount = (EntityLiving) mc.thePlayer.getRidingEntity();
            ...
            if (Configuration.useCustomPosition && !customHotbarPosOnly) {
                ...
                if (previousValues.get("HealthBar") != health + healthMax) {
                    if (mc.thePlayer.isPotionActive(Potion.getPotionById(20))) { /* WITHER POTION HEALTH */
                        drawBar(healthBar, currentValue, true, "WitherHealth");
                    } else if (mc.thePlayer.isPotionActive(Potion.getPotionById(19))) { /* POISON HEALTH */
                        drawBar(healthBar, currentValue, true, "PoisonHealth");
                    } else if (mc.thePlayer.isPotionActive(Potion.getPotionById(10))) { /* REGENERATION HEALTH  */
                ...
                if (mc.thePlayer.getTotalArmorValue() > 0 || armorBar.alwaysShow) {
                    ...
                    /* DRAW ARMOR BAR */
                    if (previousValues.get("ArmorBar") != mc.thePlayer.getTotalArmorValue() + maxArmor) {
                    ...
                    /* DRAW ARMOR BAR */
                    if (previousValues.get("ArmorBar") != mc.thePlayer.getTotalArmorValue() + maxArmor) {
                        drawBar(armorBar, mc.thePlayer.getTotalArmorValue() / (float) maxArmor, true);
                    } else {
                        drawBar(armorBar, mc.thePlayer.getTotalArmorValue() / (float) maxArmor, false);
                    }
                }
                previousValues.put(armorBar.elementName, mc.thePlayer.getTotalArmorValue() + (float) maxArmor);
                ...
                if (mc.thePlayer.isRidingHorse() && mc.thePlayer.getRidingEntity() instanceof EntityLiving) {
                    ...
                    if (previousValues.get("HorseHealthBar") != ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() + ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth()) {
                    ...
                    /* DRAW MOUNT HEALTH */
                    if (previousValues.get("HorseHealthBar") != ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() + ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth()) {
                        drawBar(horseHealthBar, mountHealthLast2 / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), true, "PastHealth");
                        if (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() > .75f) {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), true);
                        } else if (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() > .25f) {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), true, "MidHealth");
                        } else {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), true, "LowHealth");
                        }
                    } else {
                        drawBar(horseHealthBar, mountHealthLast2 / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), false, "PastHealth");
                        if (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() > .75f) {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), false);
                        } else if (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() > .25f) {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), false, "MidHealth");
                        } else {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), false, "LowHealth");
                        }
                    }
                    mountHealthLast = ((EntityLiving)mc.thePlayer.getRidingEntity()).getHealth();
                    previousValues.put(horseHealthBar.elementName, ((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() + ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth());
                }

                if (mc.thePlayer.isRidingHorse() && mc.thePlayer.getRidingEntity() instanceof EntityLiving && ((EntityLivingBase) mc.thePlayer.getRidingEntity()).getTotalArmorValue() > 0) {
                    /*
                    *
                    ...
                    *
                    * */
                    if (previousValues.get("HorseArmorBar") != ((EntityLiving) mc.thePlayer.getRidingEntity()).getTotalArmorValue() + maxArmor) {
                    ...
                    * */
                    if (previousValues.get("HorseArmorBar") != ((EntityLiving) mc.thePlayer.getRidingEntity()).getTotalArmorValue() + maxArmor) {
                        drawBar(horseArmorBar, ((EntityLiving) mc.thePlayer.getRidingEntity()).getTotalArmorValue() / maxArmor, true);
                    } else {
                        drawBar(horseArmorBar, ((EntityLiving) mc.thePlayer.getRidingEntity()).getTotalArmorValue() / maxArmor, false);
                    }
                    previousValues.put(horseArmorBar.elementName, ((EntityLiving) mc.thePlayer.getRidingEntity()).getTotalArmorValue() + (float) maxArmor);
                }
                ...
                * */
                if (Configuration.showValues) {
                    ...
                    if (healthBar.showValue)
                        mc.fontRendererObj.drawString((health + absorb) + "/" + healthMax, healthBar.textX + (healthBar.centered ? (mc.fontRendererObj.getStringWidth(health + "/" + healthMax) / 2) : 0), healthBar.textY, Integer.parseInt(healthBar.color.replace("0x", ""), 16), false);
                    GL11.glScalef(foodBar.fontSize, foodBar.fontSize, foodBar.fontSize);
                    if (foodBar.showValue)
                        mc.fontRendererObj.drawString(foodVal + "/" + 20, foodBar.textX - (foodBar.centered ? (mc.fontRendererObj.getStringWidth(foodVal + "/" + 20) / 2) : 0), foodBar.textY, Integer.parseInt(foodBar.color.replace("0x", ""), 16), false);
                    ...
                    if (armorBar.showValue && (mc.thePlayer.getTotalArmorValue() > 0 || armorBar.alwaysShow))
                        mc.fontRendererObj.drawString(mc.thePlayer.getTotalArmorValue() + "/" + Configuration.maxArmor, armorBar.textX + (armorBar.centered ? (mc.fontRendererObj.getStringWidth(mc.thePlayer.getTotalArmorValue() + "/" + Configuration.maxArmor) / 2) : 0), armorBar.textY, Integer.parseInt(armorBar.color.replace("0x", ""), 16), false);
                    ...
                    if (mc.thePlayer.isRidingHorse() && horseHealthBar.showValue)
                        mc.fontRendererObj.drawString(((EntityLivingBase) mc.thePlayer.getRidingEntity()).getHealth() + "/" + ((EntityLivingBase) mc.thePlayer.getRidingEntity()).getMaxHealth(), horseHealthBar.textX + (horseHealthBar.centered ? (mc.fontRendererObj.getStringWidth(((EntityLivingBase) mc.thePlayer.getRidingEntity()).getHealth() + "/" + ((EntityLivingBase) mc.thePlayer.getRidingEntity()).getMaxHealth()) / 2) : 0), horseHealthBar.textY, Integer.parseInt(horseHealthBar.color.replace("0x", ""), 16), false);
                    ...
                    if (mc.thePlayer.isRidingHorse() && horseArmorBar.showValue)
                        mc.fontRendererObj.drawString(((EntityLivingBase) mc.thePlayer.getRidingEntity()).getTotalArmorValue() + "/" + Configuration.maxArmor, horseArmorBar.textX + (horseArmorBar.centered ? (mc.fontRendererObj.getStringWidth(((EntityLivingBase) mc.thePlayer.getRidingEntity()).getTotalArmorValue() + "/" + Configuration.maxArmor) / 2) : 0), horseArmorBar.textY, Integer.parseInt(horseArmorBar.color.replace("0x", ""), 16), false);
                    GL11.glPopMatrix();
                }
            } else {
                if (highlight && Configuration.highlightOnDamage) {
                ...
                if (mc.thePlayer.isRidingHorse() && mc.thePlayer.getRidingEntity() instanceof EntityLiving) {
                    ...
                    if (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() > .75f) {
                        drawTexturedModalRect(xBasePos + xSize + xSpacer, yBasePos - 12, 0, 22, Math.min((int) (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() * xSize), xSize), ySize);
                    } else if (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() > .25f) {
                        drawTexturedModalRect(xBasePos + xSize + xSpacer, yBasePos - 12, 0, 33, Math.min((int) (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() * xSize), xSize), ySize);
                    } else {
                        drawTexturedModalRect(xBasePos + xSize + xSpacer, yBasePos - 12, 0, 44, Math.min((int) (((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() / ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth() * xSize), xSize), ySize);
                    }
                    mountHealthLast = ((EntityLiving)mc.thePlayer.getRidingEntity()).getHealth();
                }
                ...
                if (mc.thePlayer.isRidingHorse() && mc.thePlayer.getRidingEntity() instanceof EntityLiving && ((EntityLivingBase) mc.thePlayer.getRidingEntity()).getTotalArmorValue() > 0) {
                    ...
                    drawTexturedModalRect(xBasePos + xSize + 6, yBasePos - 24, horseArmorBar.texturePosX, horseArmorBar.texturePosY, Math.min((Math.round((float) ((EntityLivingBase) mc.thePlayer.getRidingEntity()).getTotalArmorValue() / (float) Configuration.maxArmor * xSize)), xSize), ySize);
                }

                if (Configuration.showValues) {
                    if (healthBar.showValue)
                        mc.fontRendererObj.drawString((health + absorb) + "/" + healthMax, xBasePos + 40 - (mc.fontRendererObj.getStringWidth(health + "/" + healthMax) / 2), yBasePos + 1, Integer.parseInt(healthBar.color.replace("0x", ""), 16), false);
                    if (foodBar.showValue)
                        mc.fontRendererObj.drawString(foodVal + "/" + 20, xBasePos + xSize + 50 - (mc.fontRendererObj.getStringWidth(foodVal + "/" + 20) / 2), yBasePos + 1, Integer.parseInt(foodBar.color.replace("0x", ""), 16), false);
                    if (armorBar.showValue && (mc.thePlayer.getTotalArmorValue() > 0 || armorBar.alwaysShow))
                        mc.fontRendererObj.drawString(mc.thePlayer.getTotalArmorValue() + "/" + Configuration.maxArmor, xBasePos + 40 - (mc.fontRendererObj.getStringWidth(mc.thePlayer.getTotalArmorValue() + "/" + Configuration.maxArmor) / 2), yBasePos - 11, Integer.parseInt(armorBar.color.replace("0x", ""), 16), false);
                    if (mc.thePlayer.isRidingHorse() && horseHealthBar.showValue)
                        mc.fontRendererObj.drawString(((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() + "/" + ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth(), xBasePos + xSize + 50 - (mc.fontRendererObj.getStringWidth(((EntityLiving) mc.thePlayer.getRidingEntity()).getHealth() + "/" + ((EntityLiving) mc.thePlayer.getRidingEntity()).getMaxHealth()) / 2), yBasePos - 11, Integer.parseInt(horseHealthBar.color.replace("0x", ""), 16), false);
                    if (mc.thePlayer.isRidingHorse() && horseArmorBar.showValue)
                        mc.fontRendererObj.drawString(((EntityLiving) mc.thePlayer.getRidingEntity()).getTotalArmorValue() + "/" + Configuration.maxArmor, xBasePos + xSize + 50 - (mc.fontRendererObj.getStringWidth(((EntityLivingBase) mc.thePlayer.getRidingEntity()).getTotalArmorValue() + "/" + Configuration.maxArmor) / 2), yBasePos - 11, Integer.parseInt(horseArmorBar.color.replace("0x", ""), 16), false);
                }
            }
