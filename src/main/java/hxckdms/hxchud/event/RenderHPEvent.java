                ...
                * */
                if (Configuration.showValues) {
                    ...
                    if (armorBar.showValue && (mc.player.getTotalArmorValue() > 0 || armorBar.alwaysShow))
                        mc.fontRendererObj.drawString(mc.player.getTotalArmorValue() + "/" + Configuration.maxArmor, armorBar.textX + (armorBar.centered ? (mc.fontRendererObj.getStringWidth(mc.player.getTotalArmorValue() + "/" + Configuration.maxArmor) / 2) : 0), armorBar.textY, Integer.parseInt(armorBar.color.replace("0x", ""), 16), false);
                ...
                if (Configuration.showValues) {
                    ...
                    if (armorBar.showValue && (mc.player.getTotalArmorValue() > 0 || armorBar.alwaysShow))
                        mc.fontRendererObj.drawString(mc.player.getTotalArmorValue() + "/" + Configuration.maxArmor, xBasePos + 40 - (mc.fontRendererObj.getStringWidth(mc.player.getTotalArmorValue() + "/" + Configuration.maxArmor) / 2), yBasePos - 11, Integer.parseInt(armorBar.color.replace("0x", ""), 16), false);
                    if (mc.player.isRidingHorse() && horseHealthBar.showValue)
                        mc.fontRendererObj.drawString(((EntityLiving) mc.player.getRidingEntity()).getHealth() + "/" + ((EntityLiving) mc.player.getRidingEntity()).getMaxHealth(), xBasePos + xSize + 50 - (mc.fontRendererObj.getStringWidth(((EntityLiving) mc.player.getRidingEntity()).getHealth() + "/" + ((EntityLiving) mc.player.getRidingEntity()).getMaxHealth()) / 2), yBasePos - 11, Integer.parseInt(horseHealthBar.color.replace("0x", ""), 16), false);
                    if (mc.player.isRidingHorse() && horseArmorBar.showValue)
                        mc.fontRendererObj.drawString(((EntityLiving) mc.player.getRidingEntity()).getTotalArmorValue() + "/" + Configuration.maxArmor, xBasePos + xSize + 50 - (mc.fontRendererObj.getStringWidth(((EntityLivingBase) mc.player.getRidingEntity()).getTotalArmorValue() + "/" + Configuration.maxArmor) / 2), yBasePos - 11, Integer.parseInt(horseArmorBar.color.replace("0x", ""), 16), false);
                }
            }
