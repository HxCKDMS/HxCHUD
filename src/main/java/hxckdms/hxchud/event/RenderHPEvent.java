    ...
    public void renderHealthBar(RenderGameOverlayEvent.Pre event) {
        ...
        if (event.type == RenderGameOverlayEvent.ElementType.HEALTH) {
            ...
            if (Configuration.useCustomPosition && !customHotbarPosOnly) {
                ...
                if (previousValues.get("HealthBar") != health + healthMax) {
                    if (mc.thePlayer.isPotionActive(Potion.wither)) { /* WITHER POTION HEALTH */
                        drawBar(healthBar, currentValue, true, "WitherHealth");
                    } else if (mc.thePlayer.isPotionActive(Potion.poison)) { /* POISON HEALTH */
                        drawBar(healthBar, currentValue, true, "PoisonHealth");
                    } else if (mc.thePlayer.isPotionActive(Potion.regeneration)) { /* REGENERATION HEALTH  */
                ...
                if (mc.thePlayer.isRidingHorse() && mc.thePlayer.ridingEntity instanceof EntityLiving) {
                    ...
                    if (previousValues.get("HorseHealthBar") != ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() + ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth()) {
                    ...
                    /* DRAW MOUNT HEALTH */
                    if (previousValues.get("HorseHealthBar") != ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() + ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth()) {
                        drawBar(horseHealthBar, mountHealthLast2 / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth(), true, "PastHealth");
                        if (((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth() > .75f) {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth(), true);
                        } else if (((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth() > .25f) {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth(), true, "MidHealth");
                        } else {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth(), true, "LowHealth");
                        }
                    } else {
                        drawBar(horseHealthBar, mountHealthLast2 / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth(), false, "PastHealth");
                        if (((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth() > .75f) {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth(), false);
                        } else if (((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth() > .25f) {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth(), false, "MidHealth");
                        } else {
                            drawBar(horseHealthBar, ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() / ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth(), false, "LowHealth");
                        }
                    }
                    mountHealthLast = ((EntityLiving)mc.thePlayer.ridingEntity).getHealth();
                    previousValues.put(horseHealthBar.elementName, ((EntityLiving) mc.thePlayer.ridingEntity).getHealth() + ((EntityLiving) mc.thePlayer.ridingEntity).getMaxHealth());
                }
                ...
                if (mc.thePlayer.isRidingHorse() && mc.thePlayer.ridingEntity instanceof EntityLiving && ((EntityLivingBase) mc.thePlayer.ridingEntity).getTotalArmorValue() > 0) {
                    ...
                    *
                    * */
                    if (previousValues.get("HorseArmorBar") != ((EntityLiving) mc.thePlayer.ridingEntity).getTotalArmorValue() + maxArmor) {
                    ...
                    * */
                    if (previousValues.get("HorseArmorBar") != ((EntityLiving) mc.thePlayer.ridingEntity).getTotalArmorValue() + maxArmor) {
                        drawBar(horseArmorBar, ((EntityLiving) mc.thePlayer.ridingEntity).getTotalArmorValue() / maxArmor, true);
                    } else {
                        drawBar(horseArmorBar, ((EntityLiving) mc.thePlayer.ridingEntity).getTotalArmorValue() / maxArmor, false);
                    }
                    previousValues.put(horseArmorBar.elementName, ((EntityLiving) mc.thePlayer.ridingEntity).getTotalArmorValue() + (float) maxArmor);
                }
...
//        mc.ingameGUI.drawTexturedModalRect(x, y, u, v, xSize, ySize);
        ...
        tessellator.addVertexWithUV(x, y + ySize, 0.0, (u) * f, (v + ySize) * f1);
        tessellator.addVertexWithUV(x + xSize, y + ySize, 0.0, (u + xSize) * f, (v + ySize) * f1);
        tessellator.addVertexWithUV(x + xSize, y, 0.0, (u + xSize) * f, (v) * f1);
